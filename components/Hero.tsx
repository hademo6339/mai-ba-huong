      ...
      <div className="relative z-10 h-full flex flex-col justify-end px-4 md:px-8 lg:px-16 pb-10 md:pb-16">
        ...
        <div className="w-full flex items-end justify-between relative">
            ...
            <motion.h1 
              ...
              className="text-white font-vogun font-medium text-xl md:text-3xl lg:text-4xl xl:text-5xl uppercase tracking-wider leading-[1.1] w-full text-center md:text-left drop-shadow-lg whitespace-nowrap"
